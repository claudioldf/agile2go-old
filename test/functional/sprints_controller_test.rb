...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { and_date: @sprint.and_date, daily_scrum: @sprint.daily_scrum, goal: @sprint.goal, name: @sprint.name, start_date: @sprint.start_date }
    end
  ...
  test "should update sprint" do
    put :update, id: @sprint, sprint: { and_date: @sprint.and_date, daily_scrum: @sprint.daily_scrum, goal: @sprint.goal, name: @sprint.name, start_date: @sprint.start_date }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
