  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved task as @task" do
        ...
        post :create, {:task => { "storie" => "invalid value" }}, valid_session
        assigns(:task).should be_a_new(Task)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested task" do
        ...
        Task.any_instance.should_receive(:update_attributes).with({ "storie" => "MyText" })
        put :update, {:id => task.to_param, :task => { "storie" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the task as @task" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Task.any_instance.stub(:save).and_return(false)
        put :update, {:id => task.to_param, :task => { "storie" => "invalid value" }}, valid_session
        assigns(:task).should eq(task)
      end
